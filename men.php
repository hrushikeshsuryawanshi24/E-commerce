        ...
        <div class="small-container">
            ...
            <div class="row">
                ...
                <div class="col3">
                    ...
                    <h4>Kizaar Solid men Blue white trackpant</h4>
                    <div class="rating">
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
                ...
                <div class="col3">
                    ...
                    <h4>Cotton Blend White Three-Quarter Sleeves Solid Tshirts</h4>
                    <div class="rating">
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
            ...
            <div class="row">
                <div class="col3">
                    ...
                    <h4>Beige Solid Running Shoes For Men</h4>
                    <div class="rating">
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
                ...
                <div class="col3">
                    ...
                    <h4>Attractive Loscco wallet two fold 0006 brown fiting</h4>
                    <div class="rating">
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
                ...
                <div class="col3">
                    ...
                    <h4>CLYMB Spa-6 Black Red Mesh Eva Sandals For Men</h4>
                    <div class="rating">
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
            ...
            <div class="row">
                <div class="col3">
                    ...
                    <h4>Fancy Men Ethnic Jackets</h4>
                    <div class="rating">
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
                ...
                <div class="col3">
                    ...
                    <h4>Dayractar party wear casual nahru Ethnic Jackets</h4>
                    <div class="rating">
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
                ...
                <div class="col3">
                    ...
                    <h4>Ray ban men`s aviator sunglasses</h4>
                    <div class="rating">
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
                ...
                <div class="col3">
                    ...
                    <h4>Aviator Black to gold Clear Black</h4>
                    <div class="rating">
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
